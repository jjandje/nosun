	...
	<div class="container">
		<div class="nosun-login__login">
			...
			<div id="login" class="login-popup">
				<form method="post" class="woocommerce-ResetPassword lost_reset_password nosun-form">
					...
					<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
						...
						<input type="password" class="woocommerce-Input woocommerce-Input--text input-text input" name="password_1" id="password_1" />
					</p>
					<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
						<label for="password_2"><?php esc_html_e( 'Re-enter new password', 'woocommerce' ); ?>
							<span class="required">*</span></label>
						<input type="password" class="woocommerce-Input woocommerce-Input--text input-text input" name="password_2" id="password_2" />
					</p>
