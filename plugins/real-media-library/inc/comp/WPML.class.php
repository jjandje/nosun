...
class WPML extends general\Base {
    ...
    public function sqlstatement_select_fields($fields) {
        global $sitepress;
        $currentLanguage = $sitepress->get_current_language();
        $fields[1] = "rmlicl.cnt_$currentLanguage AS cnt, IFNULL(rmlicl.cnt_$currentLanguage, (
    ...
    public function updateCountCache($folders, $attachments, $where) {
        ...
        foreach (array_keys($langs) as $code) {
            $setters[] = "cnt_$code = (" . $this->getSingleCountSql($code) . ")";
        }
    ...
    public function _dbDeltaCountCache() {
        ...
        if (count($langs) > 0) {
            ...
            foreach ($langs as $code) {
                $keys .= "cnt_$code mediumint(10) DEFAULT NULL,
    		  ";
            }
