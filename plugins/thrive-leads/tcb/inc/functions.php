...
function tve_render_custom_menu( $attributes ) {
	$custom_menu_items     = array( 'Home' => array(), 'About us' => array( 'Team', 'Company' ), 'Blog' => array() );
	...
	$custom_menu_html .= '<ul ' . $ul_custom_color . ' id="menu-main-menu" class="tve_w_menu ' . $attributes['dir'] . ' ">';
