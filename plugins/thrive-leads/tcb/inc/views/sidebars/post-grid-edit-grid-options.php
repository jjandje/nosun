...
<div class="tcb-text-center">
	<p><?php echo __( 'Editing Post Grid Options', 'thrive-cb' ); ?></p>
	<button class="click tve-btn tve-button grey" data-fn="f:main.EditMode.exit"><?php echo __( 'Exit Edit Mode', 'thrive-cb' ); ?></button>
</div>

<div id="tve-postgrid-layout-component" class="tve-component margin-top-15" data-view="PostGridLayout">
