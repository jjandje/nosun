...
1. Visit [developers.facebook.com/apps](http://developers.facebook.com/apps) and click "Add a New App."
2. When the "Create a New App ID" window pops up, type in a name (i.e. the name of your site) & contact e-mail, and click "Create App ID."
3. Go to Settings->Basic (link on the left), click "Add Platform" (at the bottom), "Website," then fill in your "Site URL."  Note: http://example.com/ and http://www.example.com/ are *not* the same.
4. Also on the "Settings" page, note the App ID and App Secret (you'll need them in a minute), and save changes.
5. Go to the "App Review" page (link on the left) and make the app public (flip the switch at the top).
